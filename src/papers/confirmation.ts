...
export function sourceConfirmation(requestId:string,snapshot:PdfSourceSnapshot,evidence:PdfDisplayedEvidence):SourceConfirmation {
...
export function validateSourceConfirmation(receipt:SourceConfirmation,requestId:string,snapshot:PdfSourceSnapshot):void {
