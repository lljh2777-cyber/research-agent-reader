 ...
 * optional titles and angle-wrapped targets), or HTML href/src in all
 * attribute spellings (quoted, single-quoted, unquoted, spaced `=`). Only
 * external web schemes and in-document anchors are allowed. Controlled
 * cross-references will be generated by the plugin itself in a later
 * iteration.
 */
