import type { ReadingBackend, ReadingSession, ReadingSource } from "../reading/types";
...
export interface AssistantSource { id: string; kind: "paper" | "knowledge"; path: string; label: string; text: string; hash: string; page?: number; start?: number; end?: number; role: string; evidenceId?: string; structured?: StructuredReadingLocation; }
