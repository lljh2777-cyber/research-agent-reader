...
export interface AssistantAction { id: string; kind: "curation" | "export" | "advance"; nodeIds: string[]; target: string; scope: "node" | "branch" | "session"; contextHash: string; state: "prepared" | "opened"; }
