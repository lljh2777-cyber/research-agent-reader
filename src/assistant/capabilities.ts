...
export const ASSISTANT_CAPABILITIES = [
	{ name: "reading_context", label: "读取阅读进度", description: "列出当前论文的节点与个人理解状态。state 为 all/understood/revisit/question/unmarked；offset 从 0 开始分页，每次 12 项。", properties: { state: string, offset: { type: "integer" } } },
