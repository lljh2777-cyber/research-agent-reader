...
for (const name of ["sessions", "progress", "teaching", "planning", "catalog", "documents", "layout", "navigation", "presentation", "engine", "usage", "outcomes", "backends", "branches", "export", "export_review", "integration"]) {
