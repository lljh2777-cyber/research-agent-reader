...
R1 页面浏览继续保持只读，不自动完整核验所有旧包；仅在用户明确保存时写人工状态或主要笔记选择，不把暂定科学状态显示为已审阅。关联代码及 R1 整体收尾尚未完成。首页摘要只读已保存记录，不代表完整核验或实时状态。T1 尚需独立教学审阅及必要修正；当前用户自评和开发者初读不能替代这一门槛。
