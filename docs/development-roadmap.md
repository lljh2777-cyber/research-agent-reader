...
更新日期：2026-09-12。最初分析基线为 `codex/research-learning-map` 的 `0.51.2`，提交 `d3a6e7525f2c604ae314c13925454c63f083f554`；当前运行基线为 `0.67.0`。T0、R1 首批导航、人工阅读状态与主要笔记选择、T1.1／T1.2 开发预览、T1.3A 理解标记与导出、T1.3B 首次答题、T1.3C 规则对照和 T1.3D 新题检验已交付，历史阶段记录保留。
